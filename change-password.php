...
$msg="Your current password is wrong";
	...
	$_SESSION['cpassword'] = md5($_POST['currentpassword']);
	$_SESSION['npassword'] = md5($_POST['newpassword']);
	$sql = "SELECT * FROM tbluser WHERE ID = '$userid' ";
	$res = $con->query($sql);
	$try = $res->fetch_assoc();
	$Email = $try['Email'];
    $subject = "Email for changing password";
    $randomNum = substr(str_shuffle("0123456789"),0,6);
    $message = "Hi there,\n\nYour One-Time Password (OTP) to change your Password is " . $randomNum . ".\nPlease enter this OTP on our website to change Password.";
